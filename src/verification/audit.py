...
def _build_recon_briefing(
    ...
    return (
        ...
        "the overall completion bar — that is C1-C6 above. If the samples match a "
        "substitute this standard names for REJECTION, C4 is NOT met regardless of "
        "file counts or sizes — unless they are honestly documented as the nearest "
        "available alternative to an evidence-backed absent target (see C3).\n\n"
        f"{evidence_standard}\n\n"
